# F-100D Super Sabre control mappings
...
| Device/group | Role |
| --- | --- |
| AB9 | MOZA AB9 FFB Base • pitch and roll axes |
| MFD 1 | TM Cougar MFD • standard OSB and rocker reference |
| MFD 2 | TM Cougar MFD • standard OSB and rocker reference |
| TPR | TPR • rudder • left and right toe brakes |
| TQS | Viper TQS • thrust • sight • speed brake • armament |
| VKB | VKB F-14 Gunfighter • trim • weapons • shifted controls |
| PTO2 | CarrierAce • gear • flaps • chute • lights • jettison |
| ICP | ViperAce • armament • stations • sight • audio controls |

## Device index

| Device | Profile file | Layers | Documented assignments |
| --- | --- | --- | ---: |
| MOZA AB9 FFB Base | `MOZA AB9 FFB Base {71DA6210-432E-11f1-8001-444553540000}.diff.lua` | Base | 2 |
| T-Pendular-Rudder | `T-Pendular-Rudder {14ED3D40-3F58-11f1-8002-444553540000}.diff.lua` | Base | 3 |
| Viper TQS | `Viper TQS {C0A33440-3F54-11f1-8001-444553540000}.diff.lua` | Base, `LCtrl` | 17 |
| VKBSim Gunfighter F14 | `VKBSim Gunfighter F14 {2D5CEC70-5189-11f1-8001-444553540000}.diff.lua` | Base, `JOY_BTN7` | 17 |
| WINCTRL CarrierAce PTO 2 | `WINCTRL CarrierAce PTO 2 {19B7D090-6120-11f0-8001-444553540000}.diff.lua` | Base, `LCtrl` | 17 |
| WINCTRL ViperAce ICP | `WINCTRL ViperAce ICP {3731E2E0-4D98-11f1-8001-444553540000}.diff.lua` | Base, `JOY_BTN7` | 53 |
| F16 MFD 1 | `F16 MFD 1 {51FA60C0-CB32-11ed-800B-444553540000}.diff.lua` | Base | 0 |
| F16 MFD 2 | `F16 MFD 2 {51FA39B0-CB32-11ed-8008-444553540000}.diff.lua` | Base | 0 |
...
- Kneeboard page: `01-MOZA-AB9.png`
...
- Kneeboard page: `03-VIPER-TQS-MISSION-PACK.png`
...
- Kneeboard page: `04-VKB-F14-GUNFIGHTER.png`
...
- Kneeboard page: `05-WINCTRL-PTO2.png`
...
- Kneeboard page: `06-WINCTRL-ICP.png`
...
- Kneeboard page: `08-TM-MFD-1.png`
...
- Kneeboard page: `09-TM-MFD-2.png`
